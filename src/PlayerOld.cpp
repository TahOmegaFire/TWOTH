...
void Player::MoveX(const Uint8* keys, const Map& map)
{
	...
	CollisionBox collider(collisionBox.m_X, collisionBox.m_Y, 1, 0);
...
{	
	...
	if(!isOnGround)
	{
		...
		CollisionBox collider(collisionBox.m_X, collisionBox.m_Y, collisionBox.m_W, 1); //Top collision
		...
		collider.m_X = collisionBox.m_X; collider.m_Y = collisionBox.m_Y + collisionBox.m_H; collider.m_W = collisionBox.m_W; //Bottom (text) collision
